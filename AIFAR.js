...
Q: قامت شركة بضبط نموذج أساسي (FM) على Amazon Bedrock لإنتاج ملخصات مستندات قصيرة. تريد الشركة مقياساً آلياً يقارن كل ملخص يتم إنشاؤه بواسطة النموذج مع ملخص مرجعي مكتوب بشرياً.\nما هو المقياس الذي سيحقق هذه المتطلبات؟
أ. درجات F1 (F1 score)
...
Q: أنشأت شركة مساعد ذكاء اصطناعي لتوفير معلومات ذات صلة للموظفين حول العمليات الداخلية. يستخدم مساعد الذكاء الاصطناعي نموذجاً أساسياً مضبوطاً بدقة (FM). تريد الشركة استخدام تعليقات الموظفين لمزيد من تحسين استجابات النموذج.\nما هو الحل الذي سيحقق هذه المتطلبات؟
...
Q: ما هي خدمة AWS التي توفر مجموعة واسعة من نماذج الذكاء الاصطناعي التوليدي الأساسية عالية الأداء (FMs)؟
*أ. Amazon Bedrock
ب. Amazon Rekognition
ج. Amazon Lex
د. Amazon Kendra
...
Q: تقوم شركة بإعداد بيانات لضبط نموذج لغة كبير (LLM). يجب على الشركة اتباع مبادئ الذكاء الاصطناعي المسؤول.\nما هي الإجراءات التي ستلبي هذا المتطلب؟ (اختر اثنتين.)
...
Q: ما هي الفائدة التي تحصل عليها الشركة عند استخدام التدريب المسبق المستمر لضبط نموذج أساسي (FM)؟
...
Q: تريد شركة تطوير برمجيات زيادة سرعة طرح منتجاتها في السوق. تحتاج الشركة إلى حل يساعد المطورين في إنشاء كود برمجي واختبارات وحدة في الوقت الفعلي.\nما هي خدمة AWS التي تلبي هذه المتطلبات؟
أ. Amazon Personalize
*ب. Amazon Q Developer
ج. Amazon Comprehend
د. Amazon Kendra
...
Q: تخطط شركة لاستخدام مجموعة بيانات لتدريب نموذج ذكاء اصطناعي جديد. تحتاج الشركة إلى تحديد ما إذا كان هناك تحيز ضد مجموعة مستخدمين معينة موجوداً في مجموعة البيانات قبل تدريب النموذج.\nما هو الحل الذي سيحقق هذا المتطلب؟
...
Q: يريد ممارس ذكاء اصطناعي استخدام هندسة التوليد المعزز بالاسترجاع (RAG). ومع ذلك، تعتقد قيادة الشركة أن RAG ستجعل البنية معقدة للغاية.\nما هي الاستجابة التي ستدعم توصية ممارس الذكاء الاصطناعي باستخدام RAG؟
...
Q: قامت شركة بناء مساعد ذكاء اصطناعي يعتمد على التوليد المعزز بالاسترجاع (RAG) باستخدام Amazon Bedrock Agents. في بعض الأحيان يقدم مساعد الذكاء الاصطناعي إجابات غير مكتملة أو غير دقيقة. تريد الشركة تحسين وتقييم أداء مساعد الذكاء الاصطناعي.\nما هو الحل الذي سيحقق هذه المتطلبات؟
...
Q: تريد شركة تطوير حل ذكاء اصطناعي لاستخراج البيانات المنظمة وغير المنظمة تلقائياً من مستندات النماذج وملفات PDF الممسوحة ضوئياً.\nما هي خدمة AWS التي ستلبي هذه المتطلبات؟
أ. Amazon Polly
ب. Amazon Lex
ج. Amazon Personalize
*د. Amazon Textract
...
Q: يقوم ممارس ذكاء اصطناعي بتطوير نظام توصيات. يريد ممارس الذكاء الاصطناعي توثيق مشكلة تجارية، وافتراضات البيانات، واعتراضات التدريب، ومخاطر الاستخدام. يجب على الشركة اتباع إرشادات الشفافية والحوكمة.\nما هي ميزة Amazon SageMaker AI التي ستلبي هذه المتطلبات؟
...
Q: شركة تشغل أحمال عمل الذكاء الاصطناعي على Amazon Bedrock تحتاج إلى تقييم وتوثيق الامتثال للمعايير التنظيمية.\nما هي خدمة أو ميزة AWS التي تلبي هذه المتطلبات؟
*أ. AWS Audit Manager
...
Q: تريد شركة استخدام النماذج الأساسية (FMs) لحالات استخدام متعددة، بما في ذلك تلخيص المحتوى، وإنشاء التعليمات البرمجية، ومساعدين لخدمة العملاء.\nما هو الحل الذي سيقوم بتنفيذ النماذج الأساسية بأكثر الطرق فعالية من حيث التكلفة؟
...
Q: يريد ممارس ذكاء اصطناعي نشر وضبط النماذج الأساسية (FMs) بسرعة لمهام الذكاء الاصطناعي التوليدي (GenAI). يحتاج ممارس الذكاء الاصطناعي إلى الوصول إلى نماذج مدربة مسبقاً، وقوالب حلول، ودفاتر ملاحظات نموذجية يمكنها تسريع عملية التطوير.\nما هي ميزة أو مورد AWS الذي يلبي هذه المتطلبات؟
...
Q: تقوم شركة موارد بشرية بناء حل ذكاء اصطناعي/تعلم آلي لفحص السير الذاتية واختيار المتقدمين المناسبين لمختلف الأدوار الوظيفية.\nما هي منهجيات الذكاء الاصطناعي التي ستساعد في ضمان معاملة محايدة لجميع المجموعات الديموغرافية؟ (اختر اثنتين.)
...
Q: تحتاج شركة إلى توثيق الغرض من نموذج التعلم الآلي والمالكين والقيود.\nما هي خدمة أو ميزة AWS التي توفر هذه الإمكانية؟
أ. Amazon Bedrock
...
Q: تقوم شركة بتدريب نموذج أساسي (FM). تريد الشركة أن تكون بيانات تدريب النموذج الأساسي مُدارة جيداً وآمنة ومتوافقة طوال دورة حياة البيانات. يجب أن تتبع البيانات ممارسات الحوكمة.\nما هو الخيار الذي يعتبر استراتيجية حوكمة بيانات في AWS لإدارة البيانات عبر دورة حياتها؟
...
Q: تقوم شركة بإنشاء تطبيق ذكاء اصطناعي وكيل باستخدام خوادم بروتوكول سياق النموذج (MCP) مع واجهة سطر أوامر Amazon Q Developer CLI. تريد الشركة اتباع ممارسات الأمان الخاصة بـ MCP.\nما هي الحلول التي ستلبي هذه المتطلبات؟ (اختر اثنتين.)
...
Q: تستخدم شركة نظام ذكاء اصطناعي توليدي (GenAI) لإنشاء ملخصات طبية من سجلات المرضى. ينتج النظام أحياناً معلومات غير دقيقة تبدو ذات مصداقية.\nما هي الاستراتيجية التي ستخفف من هذه المشكلة؟
...
Q: تريد شركة استدعاء نقطة نهاية Amazon Bedrock واحدة وتتطلب من Amazon Bedrock اختيار النموذج الأساسي (FM) الأكثر ملاءمة لكل طلب. لا تريد الشركة تضمين نموذج بشكل ثابت في التعليمات البرمجية (hardcode).\nما هي ميزة أو مورد Amazon Bedrock الذي سيلبي هذه المتطلبات؟
...
Q: تستخدم شركة التوليد المعزز بالاسترجاع (RAG) في تطبيق الذكاء الاصطناعي التوليدي (GenAI) الخاص بها. تريد الشركة استخدام تقييمات قواعد معارف Amazon Bedrock لقياس مدى تجنب الاستجابات للهلوسة بناءً على النصوص المسترجعة.\nما هو المقياس الذي يلبي هذه المتطلبات؟
أ. الرفض (Refusal)
ب. الضرر (Harmfulness)
...
Q: تستخدم شركة وسائل تواصل اجتماعي نظام توصيات "إضافة كصديق" يعتمد على الذكاء الاصطناعي. تريد الشركة التأكد من أن نماذج الذكاء الاصطناعي الخاصة بها شفافة وقابلة للتفسير.\nما هو الحل الذي سيحقق هذه المتطلبات بالطريقة الأكثر كفاءة تشغيلية؟
...
Q: قامت شركة بنشر نموذج تعلم آلي. تريد الشركة تزويد العملاء الخارجيين بوصول آمن إلى النموذج من خلال تطبيقات العملاء الخاصة بهم.\nما هو الحل الذي سيحقق هذه المتطلبات؟
...
Q: تحتاج شركة إلى تقييم الملخصات التي تم إنشاؤها بواسطة الذكاء الاصطناعي مقابل النص المرجعي. يجب على الشركة قياس التشابه الدلالي وتغطية المعلومات الأساسية.\nما هي المقاييس التي تلبي هذه المتطلبات؟ (اختر اثنتين.)
أ. درجات F1 (F1 score)
*ب. BERTScore
...
Q: شركة لوجستية عالمية تستخدم نماذج الذكاء الاصطناعي التوليدي (GenAI) على Amazon Bedrock لأتمتة الأعمال الورقية وثائق الشحن. تريد الشركة إنشاء عملية حوكمة واضحة للذكاء الاصطناعي للتأكد من استخدام النماذج بطريقة مسؤولة وتلبية سياسات الشركة.\nما هي الحلول التي ستلبي هذه المتطلبات؟ (اختر اثنتين.)
...
Q: تريد شركة إنشاء إطار عمل لحوكمة البيانات لنظام الذكاء الاصطناعي الخاص بها. يجب أن يمنح الإطار الشركة القدرة على مراقبة وقت إنتاج البيانات وتحديثها وجدولتها للحذف.\nما هو مكون حوكمة البيانات الذي يلبي هذه المتطلبات؟
...
Q: تستخدم شركة نموذجاً أساسياً (FM) لإنشاء وصف المنتجات. يوفر النموذج أحياناً معلومات غير صحيحة.\nما هو الخطر المحتمل للذكاء الاصطناعي التوليدي الذي يصفه هذا؟
أ. السمية (Toxicity)
...
Q: تقوم شركة باستخدام Amazon Bedrock AgentCore لبناء ونشر وتنزيل العوامل على نطاق واسع. تحتاج الشركة إلى تحديد الموارد المراد استخدامها.\nحدد مورد AgentCore الصحيح من القائمة التالية لكل وصف. حدد كل مورد مرة واحدة أو لا تقم بتحديده على الإطلاق.
TYPE: hotspot
