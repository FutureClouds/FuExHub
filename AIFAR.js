...
س: HOTSPOT\nقامت شركة بتطوير نموذج لغوي كبير (LLM) وتريد إتاحته لعدة فرق داخلية. تحتاج الشركة إلى اختيار وضع الاستدلال المناسب لكل فريق.\nحدد وضع الاستدلال الصحيح من القائمة التالية لكل حالة استخدام. يمكن اختيار كل وضع مرة واحدة أو أكثر.
TYPE: hotspot
...
س: HOTSPOT\nتستخدم شركة نموذج ذكاء اصطناعي توليدي لتطوير مساعد رقمي. تتضمن استجابات النموذج أحيانًا محتوى غير مرغوب فيه وقد يكون ضارًا.\nحدد سياسة التصفية الصحيحة في Amazon Bedrock من القائمة التالية لكل إجراء معالجة. يجب اختيار كل سياسة مرة واحدة.
TYPE: hotspot
...
س: HOTSPOT\nتريد شركة الحصول على استجابات أكثر تخصيصًا لمطالبات نماذج الذكاء الاصطناعي التوليدي الخاصة بها.\nحدد منهجية التخصيص الصحيحة من القائمة التالية لكل حالة استخدام. يجب اختيار كل حالة مرة واحدة.
TYPE: hotspot
...
س: HOTSPOT\nتقوم شركة بتصميم روبوت خدمة عملاء باستخدام نموذج لغوي كبير (LLM) تم ضبطه دقيقًا. تريد الشركة التأكد من أن الروبوت يستخدم خصائص الذكاء الاصطناعي المسؤول.\nحدد خاصية الذكاء الاصطناعي المسؤول الصحيحة من القائمة التالية لكل إجراء تصميم. يجب اختيار كل خاصية مرة واحدة أو عدم اختيارها.
TYPE: hotspot
...
س: HOTSPOT\nتريد شركة تطوير حل يستخدم الذكاء الاصطناعي التوليدي لإنشاء محتوى لإعلانات المنتجات، بما في ذلك صور تجريبية وشعارات دعائية.\nحدد نوع النموذج الصحيح من القائمة التالية لكل إجراء. يجب اختيار كل نوع مرة واحدة.
TYPE: hotspot
...
س: HOTSPOT\nتقوم شركة بتطوير تطبيق ذكاء اصطناعي للمساعدة في الموافقة على القروض الشخصية أو رفضها. يجب أن يلتزم التطبيق بمبادئ الذكاء الاصطناعي المسؤول.\nحدد مبدأ الذكاء الاصطناعي المسؤول الصحيح من القائمة التالية لكل إجراء. اختر كل مبدأ مرة واحدة أو عدم اختياره.
TYPE: hotspot
...
س: HOTSPOT\nحدد خدمة AWS أو الأداة الصحيحة من القائمة التالية لكل حالة استخدام. اختر كل خدمة أو أداة مرة واحدة أو عدم اختيارها.
TYPE: hotspot
...
س: HOTSPOT\nتبني شركة حلاً للذكاء الاصطناعي باستخدام Amazon SageMaker AI. تريد الشركة استخدام ميزات SageMaker AI لتسهيل تطوير التطبيقات.\nحدد ميزة SageMaker AI الصحيحة من القائمة التالية لكل حالة استخدام. اختر كل ميزة مرة واحدة.
TYPE: hotspot
...
س: HOTSPOT\nتريد شركة تجارة إلكترونية تطوير حل ذكاء اصطناعي توليدي لإنشاء توصيات منتجات مخصصة لمستخدمي التطبيق. تريد الشركة تتبع مدى فعالية هذا الحل في زيادة المبيعات وتفاعل المستخدمين داخل التطبيق.\nحدد المقياس التجاري الصحيح من القائمة التالية لكل هدف تجاري. يجب اختيار كل مقياس مرة واحدة.
TYPE: hotspot
...
س: HOTSPOT\nحدد المصطلح الصحيح في الذكاء الاصطناعي من القائمة التالية لكل عبارة. يجب اختيار كل مصطلح مرة واحدة.
TYPE: hotspot
...
س: HOTSPOT\nتقوم شركة بمراجعة نماذج الأساس (Foundation Models) في تطبيق الذكاء الاصطناعي التوليدي، وتحتاج إلى فهم خصائص متعددة للنماذج.\nحدد خاصية نموذج الأساس الصحيحة من القائمة التالية لكل تعريف. يجب اختيار كل خاصية مرة واحدة.
TYPE: hotspot
...
س: HOTSPOT\nحدد ورتب الخطوات التي تصف دورة حياة التعلم الآلي لنموذج مخصص جديد. يجب اختيار كل خطوة مرة واحدة.
TYPE: hotspot
...
س: HOTSPOT\nحدد تقنية هندسة المطالبات الصحيحة من القائمة التالية لكل وصف. يجب اختيار كل تقنية مرة واحدة أو عدم اختيارها.
TYPE: hotspot
...
س: HOTSPOT\nتقوم شركة بتحديث قاعدة بيانات المنتجات بشكل دوري عبر رفع أدلة منتجات رقمية تحتوي على نصوص وصور. تريد الشركة أتمتة هذه العملية باستخدام الذكاء الاصطناعي التوليدي.\nحدد ورتب الخطوات من القائمة التالية لأتمتة تحديث قاعدة البيانات باستخدام الذكاء الاصطناعي التوليدي. يجب اختيار كل خطوة مرة واحدة.
TYPE: hotspot
...
س: HOTSPOT\nتريد شركة استخدام التعلم الآلي لزيادة تفاعل العملاء والمبيعات. تمتلك الشركة مجموعة بيانات كبيرة تحتوي على بيانات ديموغرافية للعملاء وسجل الشراء وسلوك التصفح وتقييمات المنتجات.\nحدد نهج التعلم الآلي الصحيح لكل حالة استخدام. يجب اختيار كل نهج مرة واحدة.
TYPE: hotspot
...
س: HOTSPOT\nتريد شركة بناء حل تعلم آلي جديد، وتمتلك البيانات بالفعل. تحتاج الشركة لفهم دورة حياة التعلم الآلي قبل بناء الحل.\nحدد ورتب الخطوات الصحيحة لدورة حياة التعلم الآلي. يجب اختيار كل خطوة مرة واحدة.
TYPE: hotspot
...
س: HOTSPOT\nتريد شركة تخصيص نموذج أساس (Foundation Model). تريد فهم طرق التخصيص وأنواع البيانات المتاحة.\nحدد طريقة التخصيص الصحيحة لكل وصف. يجب اختيار كل طريقة مرة واحدة.
TYPE: hotspot
...
س: HOTSPOT\nتقوم شركة ببناء تطبيق مساعد ذكاء اصطناعي، ويجب تنفيذ عملية حوكمة أساسية للمشروع وضمان الالتزام بممارسات الذكاء الاصطناعي المسؤول.\nحدد ورتب الخطوات الصحيحة لتنفيذ عملية الحوكمة الأساسية لهذه الحالة.
TYPE: hotspot
...
س: HOTSPOT\nيقوم مختص ذكاء اصطناعي باستخدام نموذج Amazon Nova النصي. يريد تطبيق هندسة المطالبات لضمان دعم التحسين التكراري.\nحدد مكون تصميم المطالبة الصحيح لكل تعريف. يجب اختيار كل مكون مرة واحدة.
TYPE: hotspot
